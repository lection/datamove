...
public class FollowTask extends J2JTaskSupport{
...

    {
        ...
        contactChannelMap.put("P", "134");
        contactChannelMap.put("S", "136");
        contactChannelMap.put("E", "133");
        contactChannelMap.put("V", "137");
        contactChannelMap.put("M", "139");
        contactChannelMap.put("A", "140");
        contactChannelMap.put("OT", "140");
        contactChannelMap.put("", "140");
        contactChannelMap.put(null, "140");
    }
    ...
    public Object parse(Connection conn, ResultSet rs) throws DataException, SQLException {
        ...
        //跟进人
        String flUserName = rs.getString("flsales") + rs.getString("dcenter_id");
